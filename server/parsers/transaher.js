...
const ZONE_PROVINCE_MAPPINGS = {
  ...
  'ZONA 2': ['ALBACETE', 'ALMERIA', 'BARCELONA', 'CASTELLON', 'CIUDAD REAL', 'GRANADA', 'GUADALAJARA', 'JAEN', 'TOLEDO', 'VALENCIA', 'ZARAGOZA'],
  'ZONA 3': ['AVILA', 'BADAJOZ', 'BILBAO', 'BURGOS', 'CACERES', 'CADIZ', 'CORDOBA', 'CUENCA', 'GERONA', 'HUELVA', 'HUESCA', 'LERIDA', 'MADRID', 'MÁLAGA', 'PALENCIA', 'PAMPLONA', 'SEGOVIA', 'SEVILLA', 'SORIA', 'TARRAGONA', 'TERUEL', 'VALLADOLID', 'ZAMORA'],

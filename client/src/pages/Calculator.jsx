        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="flex gap-4">
              {[
                { value: 'nacional', label: 'Nacional (España)' },
                ...
                <label key={opt.value} className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    value={opt.value}
                    checked={form.destination_type === opt.value}
                    onChange={() => handleChange('destination_type', opt.value)}
          ...
          {form.destination_type === 'nacional' ? (
            <div>
              ...
              <input
                ...
                className={`w-full sm:w-36 border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-navy focus:border-transparent ${
